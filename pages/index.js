        ...
        <section className="HeroSection">
          ...
          <div className="HeroSection__top">
            ...
            <p className="HeroSection__top--text">
              ...
              everyone from legends to noobs will be a part of a week of
              fulfilled dreams in the form of tournaments, one-on-one battles,
        ...
        <section className="AboutSection" id="about">
          <div className="AboutSection__above">
            ...
            <p className="AboutSection__above--text">
              ...
              and dedication to sports. Our sports clubs get to not only
              increase their audience, but also nurture in everyone the spirit
              of competition, teamwork and sportsmanship. We endeavor to boost
              the zest for sports by bringing about a new era for sports,
              showcasing legendary clashes between the best and the brightest.
            </p>

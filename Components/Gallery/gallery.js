		...
		<div className="Gallery">
			...
			<section className="Gallery__main--images">
				<div className="Gallery__main--images__img">
					<img loading="lazy" src="/Img/image1.png" />
				</div>
				<div className="Gallery__main--images__img">
					<img loading="lazy" src="/Img/image2.png" />
				</div>
				<div className="Gallery__main--images__img">
					<img loading="lazy" src="/Img/image3.png" />
				</div>
				<div className="Gallery__main--images__img">
					<img loading="lazy" src="/Img/image4.png" />
				</div>
			</section>
			<section className="Gallery__main--bottom">
				...
				<div className="Gallery__main--bottom__arrow">
					<img loading="lazy" src="/Img/arrow.png" />
				</div>
			</section>
		</div>
	);
